...
figure(1);
plot(fuh,sqrt(Hfsq1(fuh)),fuh,sqrt(Hfsq2(fuh)),fuh,sqrt(Hfsq3(fuh)));
...
figure(2);
plot(fuh,sqrt(Gfsq1(fuh)),fuh,sqrt(Gfsq2(fuh)),fuh,sqrt(Gfsq3(fuh)));
...
[~,quants1] = quantiz(un1,quantlevels1(2:2:length(quantlevels1)), quantlevels1(1:2:length(quantlevels1)));
...
[~,quants2] = quantiz(un2,quantlevels2(2:2:length(quantlevels2)), quantlevels2(1:2:length(quantlevels2)));
